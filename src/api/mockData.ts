...
export const mockRecentSessions: UserSession[] = [
  {
    ...
    exitPage: '/checkout.html',
    actions: ['view_home', 'view_product', 'add_to_cart', 'checkout']
  },
  {
    id: 'sess_002',
    userId: 'user_456',
    ...
    device: 'Mobile',
    entryPage: '/index.html',
    exitPage: '/product.html?id=2',
    actions: ['view_home', 'view_product', 'error_encountered']
  },
  {
    id: 'sess_003',
    userId: 'user_789',
    ...
    browser: 'Safari 17',
    device: 'Desktop',
    entryPage: '/product.html?id=2',
    exitPage: '/checkout.html',
    actions: ['view_product', 'add_to_cart', 'proceed_to_checkout', 'session_timeout']
  },
  {
    id: 'sess_004',
    userId: 'user_321',
    ...
    entryPage: '/index.html',
    exitPage: '/product.html?id=2',
    actions: ['view_home', 'browse_products', 'view_product_details', 'payment_error_retry']
  },
  {
    id: 'sess_005',
    userId: 'user_654',
    ...
    browser: 'Edge 118',
    device: 'Desktop',
    entryPage: '/checkout.html',
    exitPage: '/index.html',
    actions: ['checkout_completion', 'order_confirmation', 'return_home']
  }
]
...
export const mockAPIErrors: APIError[] = [
  {
    ...
    method: 'GET',
    statusCode: 500,
    errorMessage: 'Internal Server Error - Product database connection timeout',
    stackTrace: 'Error: Connection timeout\n  at Database.connect (db.js:45)\n  at ProductController.load (product.js:23)\n  at async Router.handle (router.js:156)',
    sessionId: 'sess_042',
    userId: 'user_890',
  ...
  },
  {
    ...
    method: 'POST',
    statusCode: 400,
    errorMessage: 'Validation Error - Invalid product ID or quantity',
    sessionId: 'sess_053',
    userId: 'user_123',
  ...
  },
  {
    ...
    method: 'POST',
    statusCode: 401,
    errorMessage: 'Unauthorized - Session expired during checkout',
    sessionId: 'sess_065',
    userId: 'user_456',
  ...
  },
  {
    ...
    method: 'GET',
    statusCode: 504,
    errorMessage: 'Gateway Timeout - Inventory check exceeded time limit',
    stackTrace: 'Error: Gateway timeout\n  at InventoryService.check (inventory.js:89)\n  at ProductController.validate (product.js:156)',
    sessionId: 'sess_078',
    userId: 'user_789',
  ...
  },
  {
    ...
    method: 'GET',
    statusCode: 429,
    errorMessage: 'Too Many Requests - Product recommendation service rate limit exceeded',
    sessionId: 'sess_103',
    userId: 'user_567',
