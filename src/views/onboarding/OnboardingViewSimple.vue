<template>
  <div class="onboarding-page p-6 max-w-6xl mx-auto">
    ...
    <div class="mb-8">
      ...
      <p class="text-gray-600">Welcome to your project onboarding! Follow these steps to integrate Radar-Snap analytics.
      </p>
    </div>
      ...
      <div class="flex items-center justify-between">
        <div v-for="(step, index) in steps" :key="index" class="flex items-center">
          ...
          <div v-if="index < steps.length - 1" class="w-16 h-1 mx-4 bg-gray-200 rounded">
            <div class="h-full bg-blue-500 rounded transition-all" :style="{ width: step.completed ? '100%' : '0%' }">
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-8">
      ...
      <div class="border-b border-gray-200 mb-6">
        <nav class="-mb-px flex space-x-8">
          <button v-for="platform in platforms" :key="platform.id" @click="selectedPlatform = platform.id"
            class="py-2 px-1 border-b-2 font-medium text-sm transition-colors" :class="{
          ...
          <!-- <div class="relative">
            ...
            <div class="space-y-3">
              <div class="relative bg-gray-900 rounded-lg p-4">
                ...
                <button @click="copyCode('NPM Command', 'npm install @radar-snap/web')"
              ...
              <div class="relative bg-gray-900 rounded-lg p-4">
                ...
                <button @click="copyCode('NPM Usage', npmUsage)"
                  class="absolute top-3 right-3 bg-gray-700 hover:bg-gray-600 text-white px-3 py-2 rounded-md text-xs font-medium transition-colors flex items-center">
                  <i class="pi pi-copy mr-2"></i>
                  Copy
                </button>
        ...
        <div class="space-y-6">
          ...
          <div class="relative">
            ...
            <div class="relative bg-gray-900 rounded-lg p-4">
              ...
              <button @click="copyCode('React Setup', reactUsage)"
                class="absolute top-3 right-3 bg-gray-700 hover:bg-gray-600 text-white px-3 py-2 rounded-md text-xs font-medium transition-colors flex items-center">
                <i class="pi pi-copy mr-2"></i>
                Copy
              </button>
        ...
        <div class="space-y-6">
          ...
          <div class="relative">
            ...
            <div class="relative bg-gray-900 rounded-lg p-4">
              ...
              <button @click="copyCode('Vue Setup', vueUsage)"
                class="absolute top-3 right-3 bg-gray-700 hover:bg-gray-600 text-white px-3 py-2 rounded-md text-xs font-medium transition-colors flex items-center">
                <i class="pi pi-copy mr-2"></i>
                Copy
              </button>
      ...
      <div v-if="selectedPlatform === 'mobile'">
        <div class="space-y-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <button v-for="mobileType in mobileTypes" :key="mobileType.id" @click="selectedMobileType = mobileType.id"
          ...
          <div v-if="selectedMobileType === 'react-native'" class="relative">
            ...
            <div class="relative bg-gray-900 rounded-lg p-4">
              ...
              <button @click="copyCode('React Native', reactNativeUsage)"
                class="absolute top-3 right-3 bg-gray-700 hover:bg-gray-600 text-white px-3 py-2 rounded-md text-xs font-medium transition-colors flex items-center">
                <i class="pi pi-copy mr-2"></i>
                Copy
              </button>
          ...
          <div v-if="selectedMobileType === 'ios'" class="relative">
            ...
            <div class="relative bg-gray-900 rounded-lg p-4">
              ...
              <button @click="copyCode('iOS Swift', iosUsage)"
                class="absolute top-3 right-3 bg-gray-700 hover:bg-gray-600 text-white px-3 py-2 rounded-md text-xs font-medium transition-colors flex items-center">
                <i class="pi pi-copy mr-2"></i>
                Copy
              </button>
          ...
          <div v-if="selectedMobileType === 'android'" class="relative">
            ...
            <div class="relative bg-gray-900 rounded-lg p-4">
              ...
              <button @click="copyCode('Android Kotlin', androidUsage)"
                class="absolute top-3 right-3 bg-gray-700 hover:bg-gray-600 text-white px-3 py-2 rounded-md text-xs font-medium transition-colors flex items-center">
                <i class="pi pi-copy mr-2"></i>
                Copy
              </button>
